...
class ReconocerProblema extends StatefulWidget {
  final VoidCallback onProblemAdmitted;

  const ReconocerProblema({super.key, required this.onProblemAdmitted});

  @override
  State<ReconocerProblema> createState() => _ReconocerProblemaState();
}

class _ReconocerProblemaState extends State<ReconocerProblema> {
  late YoutubePlayerController _controller;
  bool _isPlayerReady = false;
  bool _showContinueButton = false;

  final String _videoId = '0WaYLWDPMB0';
        ...
        builder: (context, constraints) {
          return Container(
            ...
            child: Column(
              children: [
                SizedBox(
                  height: constraints.maxHeight * 0.45, // 50% de la pantalla
                  width: double.infinity,
                  child: YoutubePlayer(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Este video te guiará para entender a fondo la naturaleza de tu desafío. Observa cómo se manifiesta y reconoce su impacto en tu vida.',
