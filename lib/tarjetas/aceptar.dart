...
class AceptarProblemaScreen extends StatefulWidget {
  final VoidCallback onProblemAdmitted;

  const AceptarProblemaScreen({super.key, required this.onProblemAdmitted});

  @override
  State<AceptarProblemaScreen> createState() => _AceptarProblemaScreenState();
}

class _AceptarProblemaScreenState extends State<AceptarProblemaScreen> {
  late YoutubePlayerController _controller;
  bool _isPlayerReady = false;
  bool _showContinueButton = false;

  final String _videoId = 'e9dZQelULDk';
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Este video te ofrece  aceptar plenamente tu realidad. La aceptación es el fundamento para el cambio; prepárate para dar el paso hacia la recuperación.',
