...
class VerificacionEmailScreen extends StatefulWidget {
  ...
  @override
  State<VerificacionEmailScreen> createState() =>_VerificacionEmailScreenState();
}
  ...
  Future<void> _verificarEmail() async {
    ...
    if (user != null) {
      Navigator.pushReplacementNamed(
        ...
        context,
        '/cambio_password',arguments: {'email': email}, // Ruta para la siguiente pantalla
      );
    } else {await showCustomAlertDialog(
        // ignore: use_build_context_synchronously
        context: context,
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(color: ColoresApp.texto1, // Color del borde
                                  width: 2,
                                ),
                                ...
                                children: [
                                  ...
                                  Text(
                                    ...
                                    style:  menuSectionTitleStyle.copyWith(
                                      color: ColoresApp.iconColor.withValues(alpha: 0.6,),),
                                    textAlign: TextAlign.center,
                                  ),
